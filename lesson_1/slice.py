...
def even(s):        # 2016.03.17_12:20:02 checked. prusanov
    # +++ ваш код +++
...
# Решите задачу в одну строчку используя срезы.
def reverse(s):     # 2016.03.17_12:20:05 checked. prusanov
    # +++ ваш код +++    
...
def shift(s):       # 2016.03.17_12:20:10 checked. prusanov
    # +++ ваш код +++
    a = s.split()
    return a.pop() + ' '+ ' '.join(a)       # хорошее решение
...
def palindrome(d):          # 2016.03.17_12:21:04 checked. prusanov
    # +++ ваш код +++
...
def inside(s):      # 2016.03.17_12:22:09 checked. prusanov
    # +++ ваш код +++
    a = s.split()    
    j = len(a) // 2
    c = a[1:j] + [a[0],a[-1]] + a[j:len(a)-1]
                # чтобы получить последний элемент можно записать:  a[-1]  - короче и удобней ;)
    return ' '.join(c)
